...
class TestGetPriorityChoices( BaseUserTestCase ):
    ...
    def test_getPriorityChoices( self ):
        ...
        oSearch     = Search(
                cTitle= sSearch, cPriority = 'C1', iUser = self.user1 )
        oSearch.save()
        #
        sSearch     = "My clever search D"
        oSearch     = Search(
                cTitle= sSearch, cPriority = 'D2', iUser = self.user1 )
        oSearch.save()
        #
        sSearch     = "My clever search 2"
        oSearch     = Search(
                cTitle= sSearch, cPriority = 'A1', iUser = self.user1 )
        oSearch.save()
        #
        tChoices = getPriorityChoices( Search, self.user1 )
        #
        tExpect = (
        ...
        #
        tChoices = getPriorityChoices( Search, self.user1, 'A1' )
        #
        tExpect = (
