# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-11-12 03:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctitle', models.CharField(db_index=True, max_length=48, verbose_name='brand name')),
                ...
                ('istars', core.models.IntegerRangeField(verbose_name='desireability, 10 star brand is most desireable')),
                ('ccomment', models.TextField(blank=True, null=True, verbose_name='comments')),
                ('cnationality', django_countries.fields.CountryField(max_length=2, null=True, verbose_name='nationality')),
                ('cexcludeif', models.TextField(blank=True, verbose_name='exclude item when this text is found')),
